...
export default class extends Controller {
  static targets = ["shell", "body", "toggleButton", "toggleGlyph", "toggleLabel", "resizer"]
  static values = {
  ...
  _updateToggleUi() {
    ...
    this.toggleButtonTarget.setAttribute("aria-expanded", c ? "false" : "true")
    if (this.hasToggleGlyphTarget) {
      this.toggleGlyphTarget.textContent = c ? "▶" : "◀"
    }
    if (this.hasToggleLabelTarget) {
      this.toggleLabelTarget.textContent = c ? "展開" : "折りたたむ"
    }
  }
}
