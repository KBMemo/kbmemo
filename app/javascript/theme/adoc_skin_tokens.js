...
export const ADOC_TOKEN_META = {
  ...
  "--mg-sidebar-block-bg": { label: "サイドバーブロック背景" },
  "--mg-example-block-bg": { label: "例ブロック背景" },
...
export const ADOC_TOKEN_DEFAULTS = {
  default: {
    ...
    "--mg-sidebar-block-bg": "#eeeeee",
    "--mg-example-block-bg": "#fafafa",
    "--mg-code-bg": "#f7f7f8",
  ...
  dark: {
    ...
    "--mg-sidebar-block-bg": "#21262d",
    "--mg-example-block-bg": "#161b22",
    "--mg-code-bg": "#161b22",
  ...
  sepia: {
    ...
    "--mg-sidebar-block-bg": "#e8dcc8",
    "--mg-example-block-bg": "#f0e6d2",
    "--mg-code-bg": "#ebe3d0",
